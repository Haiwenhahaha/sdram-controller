...
VL_INLINE_OPT void Vtoplevel___024root___nba_sequent__TOP__0(Vtoplevel___024root* vlSelf) {
    ...
    vlSelfRef.sdram_we_pad_o = (1U & ((IData)(vlSelfRef.toplevel__DOT__sdram_controlleri__DOT__command) 
                                      >> 3U));
    vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__rd_syn1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__rd_r));
    vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__wr_syn1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__wr_r));
    vlSelfRef.toplevel__DOT__wr_fifoi__DOT__wr_syn1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__wr_fifoi__DOT__wr_r));
}
...
VL_INLINE_OPT void Vtoplevel___024root___nba_sequent__TOP__1(Vtoplevel___024root* vlSelf) {
    ...
    if (vlSelfRef.rst_n_pad_i) {
        ...
        if (vlSelfRef.toplevel__DOT__wr_enable) {
            ...
            vlSelfRef.toplevel__DOT__wr_fifoi__DOT__wr_data_r 
                = (((QData)((IData)((((IData)(vlSelfRef.gpio1_i) 
                                      << 0x1cU) | (
        ...
        if (vlSelfRef.toplevel__DOT__rd_enable) {
            ...
            vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__wr_data_r 
                = (0xffffffU & (((IData)(vlSelfRef.gpio1_i) 
                                 << 0x14U) | (((IData)(vlSelfRef.gpio1_i) 
                                               << 0x10U) 
                                              | (((IData)(vlSelfRef.gpio1_i) 
                                                  << 0xcU) 
                                                 | (((IData)(vlSelfRef.gpio1_i) 
    ...
    vlSelfRef.toplevel__DOT__wr_fifoi__DOT__rd_syn1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__wr_fifoi__DOT__rd_r));
    vlSelfRef.toplevel__DOT__dnano_interfacei__DOT__dbl_clck_rst_n 
        = ((~ ((IData)(vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__wr_fifo_cnt) 
               | (IData)(vlSelfRef.toplevel__DOT__wr_fifoi__DOT__wr_fifo_cnt))) 
           & (IData)(vlSelfRef.rst_n_pad_i));
    vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__rd_syn1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__rd_r));
    vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__rd_ack2 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__rd_ack1));
    vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__wr_ack2 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__wr_ack1));
    vlSelfRef.toplevel__DOT__wr_fifoi__DOT__wr_ack2 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__wr_fifoi__DOT__wr_ack1));
    vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__wr_syn1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__wr_r));
    vlSelfRef.toplevel__DOT__dnano_interfacei__DOT__rd_ack_r 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__rd_fifo_cnt));
    vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__rd_ack1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__rd_syn2));
    vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__wr_ack1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__wr_syn2));
    vlSelfRef.toplevel__DOT__wr_fifoi__DOT__wr_ack1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__wr_fifoi__DOT__wr_syn2));
    vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__rd_fifo_cnt 
        = __Vdly__toplevel__DOT__rddata_fifoi__DOT__rd_fifo_cnt;
}
...
VL_INLINE_OPT void Vtoplevel___024root___nba_sequent__TOP__2(Vtoplevel___024root* vlSelf) {
    ...
    vlSelfRef.toplevel__DOT__dnano_interfacei__DOT__double_clicki__DOT__btn_now 
        = ((IData)(vlSelfRef.toplevel__DOT__dnano_interfacei__DOT__dbl_clck_rst_n) 
           && (1U & (~ (IData)(vlSelfRef.btn_n_pad_i))));
...
VL_INLINE_OPT void Vtoplevel___024root___nba_sequent__TOP__3(Vtoplevel___024root* vlSelf) {
    ...
    vlSelfRef.toplevel__DOT__wr_fifoi__DOT__rd_ack2 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__wr_fifoi__DOT__rd_ack1));
    vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__rd_ack2 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__rd_ack1));
    vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__wr_ack2 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__wr_ack1));
    vlSelfRef.toplevel__DOT__wr_fifoi__DOT__rd_ack1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__wr_fifoi__DOT__rd_syn2));
    vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__rd_ack1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rdaddr_fifoi__DOT__rd_syn2));
    vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__wr_ack1 
        = ((IData)(vlSelfRef.rst_n_pad_i) && (IData)(vlSelfRef.toplevel__DOT__rddata_fifoi__DOT__wr_syn2));
...
void Vtoplevel___024root___eval_debug_assertions(Vtoplevel___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (VL_UNLIKELY(((vlSelfRef.sys_clk_pad_i & 0xfeU)))) {
        Verilated::overWidthError("sys_clk_pad_i");}
    if (VL_UNLIKELY(((vlSelfRef.rst_n_pad_i & 0xfeU)))) {
        Verilated::overWidthError("rst_n_pad_i");}
    if (VL_UNLIKELY(((vlSelfRef.btn_n_pad_i & 0xfeU)))) {
        Verilated::overWidthError("btn_n_pad_i");}
    if (VL_UNLIKELY(((vlSelfRef.gpio1_i & 0xf0U)))) {
        Verilated::overWidthError("gpio1_i");}
}
#endif  // VL_DEBUG
