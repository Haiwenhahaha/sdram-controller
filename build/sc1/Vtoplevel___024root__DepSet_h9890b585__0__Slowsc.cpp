...
VL_ATTR_COLD void Vtoplevel___024root___dump_triggers__act(Vtoplevel___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge __Vcellinp__toplevel__sys_clk_pad_i)\n");
    }
...
VL_ATTR_COLD void Vtoplevel___024root___dump_triggers__nba(Vtoplevel___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge __Vcellinp__toplevel__sys_clk_pad_i)\n");
    }
...
VL_ATTR_COLD void Vtoplevel___024root___ctor_var_reset(Vtoplevel___024root* vlSelf) {
    ...
    vlSelf->__Vcellinp__toplevel__gpio1_i = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 8901480595347276188ull);
    vlSelf->__Vcellinpt__toplevel__gpio0_io = VL_SCOPED_RAND_RESET_I(8, __VscopeHash, 2799987308428319751ull);
    vlSelf->__Vcellinpt__toplevel__sdram_dq_pad_io = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 16966460660988062406ull);
    vlSelf->__Vcellinp__toplevel__btn_n_pad_i = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9130475114661114487ull);
    vlSelf->__Vcellinp__toplevel__rst_n_pad_i = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11393939794357374692ull);
    vlSelf->__Vcellinp__toplevel__sys_clk_pad_i = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10103161778407632127ull);
    ...
    vlSelf->__Vtrigprevexpr___TOP____Vcellinp__toplevel__sys_clk_pad_i__0 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11118606874037474064ull);
